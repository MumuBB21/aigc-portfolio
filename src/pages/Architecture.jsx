...
export default function Architecture({ lang, onBack }) {
  const { title, ratio, images, notes } = works.architecture;
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach(p => {
        ...
        ctx.fillStyle = `rgba(90,143,255,${p.opacity})`;
        ctx.fill();
      });
    ...
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '2rem' }}>
      ...
      <button
        ...
        style={{
          ...
          textDecorationColor: 'rgba(90,143,255,0.8)',
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.textDecorationColor = '#5a8fff';
          e.currentTarget.style.textShadow = '0 0 20px rgba(90,143,255,1)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'scale(1)';
          e.currentTarget.style.textDecorationColor = 'rgba(90,143,255,0.8)';
          e.currentTarget.style.textShadow = '0 0 10px rgba(90,143,255,0.7)';
        }}
      >
      ...
      <h1 style={{
        fontSize: '2.3rem',
        marginBottom: '2.6rem',
        background: 'linear-gradient(90deg, #5a8fff, #a0c0ff)',
