...
export default function Posters({ lang, onBack }) {
  const { title, ratio, images, notes } = works.posters;
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach(p => {
        ...
        ctx.fillStyle = `rgba(255,158,90,${p.opacity})`;
        ctx.fill();
      });
    ...
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '2rem' }}>
      ...
      <button
        ...
        style={{
          ...
          color: '#ffffff',
          textShadow: '0 0 10px rgba(255,158,90,0.7)',
          textDecoration: 'underline',
          textDecorationColor: 'rgba(255,158,90,0.8)',
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.textDecorationColor = '#ff9e5a';
          e.currentTarget.style.textShadow = '0 0 20px rgba(255,158,90,1)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'scale(1)';
          e.currentTarget.style.textDecorationColor = 'rgba(255,158,90,0.8)';
          e.currentTarget.style.textShadow = '0 0 10px rgba(255,158,90,0.7)';
        }}
      >
      ...
      <h1 style={{
        fontSize: '2.3rem',
        marginBottom: '2.6rem',
        background: 'linear-gradient(90deg, #ff9e5a, #ffd1a0)',
